...
<html>
	<head>
		...
		<script type="text/javascript">
			//{'키' : '값'}
			//값에 넣을 수 있는 데이터
			//숫자 : 정수, 실수 , 지수 -> JSON에서는 8진수나 16진수를 표현하는법이 없다.
			//문자열
			//논리형 : true/false
			//객체
			//배열
			...
			var p_arr = [
						...
						{'name' : '고길동', 'age' : 25, 'tel' : '010-2222-2222'}
						]
			...
			var course = {'name' : '웹앱개발',
							...
							'end' : '2030-07-07',
							'sub' : ['java', 'jsp', 'spring'],
							'student' : [{'name' : '홍길동' , 'age' : 20},{'name' : '고길동' , 'age' : 25}]}
			document.write("<hr>");
			...
			document.write("학생 : " +course.student[1].name + " / " + course.student[1].age + "<br>");
